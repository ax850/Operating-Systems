...
main(int argc, char **argv)
{
	 ...
	 * expected. */
	volatile int setcontext_called = 0;	//The value of this variable may change at any time (interrupts)
	int err;
	...
	printf("argc = %d\n", argc);
	printf("argv = %p\n", (void *)argv);	// %p is to show address
	...
	/* Answer: I think the edi and rsi registers contain the these two parameters*/
	...
	/*Answer setcontext doesn't return anything on sucess*/
	assert(0);
}
